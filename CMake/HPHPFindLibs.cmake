...
CHECK_FUNCTION_EXISTS("cli_safe_read" HAVE_MYSQL_WITH_CLI_SAFE_READ)
CHECK_FUNCTION_EXISTS("net_field_length" HAVE_MYSQL_WITH_NET_FIELD_LENGTH)
if (HAVE_MYSQL_WITH_CLI_SAFE_READ AND HAVE_MYSQL_WITH_NET_FIELD_LENGTH)
  add_definitions(-DHAVE_MYSQL_LOCALIZATION_SUPPORT=1)
endif()
...
if (ICU_FOUND)
	if (ICU_VERSION VERSION_LESS "4.2")
		add_definitions(-DHAVE_OLD_LIBICU=1)
	endif ()
